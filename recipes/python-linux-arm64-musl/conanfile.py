"""Conan recipe — aarch64-unknown-linux-musl Python3 sysroot (python-build-standalone).
...
class PythonLinuxArm64Musl(ConanFile):
    ...
    name = "python-linux-arm64-musl"
    description = (
        "Pre-built aarch64-unknown-linux-musl Python sysroot for PyO3 cross-compile. "
