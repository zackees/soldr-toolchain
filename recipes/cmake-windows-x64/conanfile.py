"""Conan recipe — `windows-x64` CMake prebuilt bundle.
...
class CmakeWindowsX64(ConanFile):
    name = "cmake-windows-x64"
    description = (
        "Pre-built CMake bundle for windows-x64. Source: official Kitware/CMake release binaries. Carries bin/cmake + bin/ctest + bin/cpack and the full share/cmake-<maj.min>/ module tree; docs/man dropped."
    )
