"""Conan recipe — aarch64-pc-windows-msvc Python3 sysroot (python-build-standalone).

soldr#931 / soldr#997 Phase A. Sibling of recipes/python-windows-x64/;
...
class PythonWindowsArm64(ConanFile):
    ...
    description = (
        "Pre-built aarch64-pc-windows-msvc Python sysroot for PyO3 cross-compile. "
