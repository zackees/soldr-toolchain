"""Conan recipe — `darwin-x64` uv prebuilt bundle.
...
class UvDarwinX64(ConanFile):
    name = "uv-darwin-x64"
    description = (
        "Pre-built uv bundle for darwin-x64. Source: official astral-sh/uv release binaries. Carries bin/uv + bin/uvx."
    )
