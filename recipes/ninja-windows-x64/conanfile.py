"""Conan recipe — `windows-x64` Ninja prebuilt bundle.
...
class NinjaWindowsX64(ConanFile):
    name = "ninja-windows-x64"
    description = (
        "Pre-built Ninja bundle for windows-x64. Source: official ninja-build/ninja release binaries. Carries just bin/ninja."
    )
    license = "Apache-2.0"
