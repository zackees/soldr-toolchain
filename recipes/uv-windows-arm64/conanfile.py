"""Conan recipe — `windows-arm64` uv prebuilt bundle.
...
class UvWindowsArm64(ConanFile):
    ...
    name = "uv-windows-arm64"
    description = (
        "Pre-built uv bundle for windows-arm64. Source: official astral-sh/uv release binaries. Carries bin/uv + bin/uvx."
    )
