"""Conan recipe — `linux-arm64-gnu` CMake prebuilt bundle.
...
class CmakeLinuxArm64Gnu(ConanFile):
    ...
    name = "cmake-linux-arm64-gnu"
    description = (
        "Pre-built CMake bundle for linux-arm64-gnu. Source: official Kitware/CMake release binaries. Carries bin/cmake + bin/ctest + bin/cpack and the full share/cmake-<maj.min>/ module tree; docs/man dropped."
    )
