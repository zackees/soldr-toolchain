"""Conan recipe — `darwin-x64` Ninja prebuilt bundle.
...
class NinjaDarwinX64(ConanFile):
    name = "ninja-darwin-x64"
    description = (
        "Pre-built Ninja bundle for darwin-x64. Source: official ninja-build/ninja release binaries. Carries just bin/ninja."
    )
    license = "Apache-2.0"
