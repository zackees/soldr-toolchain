"""Conan recipe — x86_64-apple-darwin Python3 sysroot (python-build-standalone).
...
class PythonDarwinX64(ConanFile):
    ...
    description = (
        "Pre-built x86_64-apple-darwin Python sysroot for PyO3 cross-compile. "
