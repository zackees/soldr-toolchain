"""Conan recipe — x86_64-unknown-linux-gnu Python3 sysroot (python-build-standalone).
...
class PythonLinuxX64Gnu(ConanFile):
    ...
    name = "python-linux-x64-gnu"
    description = (
        "Pre-built x86_64-unknown-linux-gnu Python sysroot for PyO3 cross-compile. "
