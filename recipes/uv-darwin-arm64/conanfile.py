"""Conan recipe — `darwin-arm64` uv prebuilt bundle.
...
class UvDarwinArm64(ConanFile):
    name = "uv-darwin-arm64"
    description = (
        "Pre-built uv bundle for darwin-arm64. Source: official astral-sh/uv release binaries. Carries bin/uv + bin/uvx."
    )
