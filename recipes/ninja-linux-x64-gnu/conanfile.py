"""Conan recipe — `linux-x64-gnu` Ninja prebuilt bundle.
...
class NinjaLinuxX64Gnu(ConanFile):
    name = "ninja-linux-x64-gnu"
    description = (
        "Pre-built Ninja bundle for linux-x64-gnu. Source: official ninja-build/ninja release binaries. Carries just bin/ninja."
    )
    license = "Apache-2.0"
