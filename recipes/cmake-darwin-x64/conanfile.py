"""Conan recipe — `darwin-x64` CMake prebuilt bundle.
...
class CmakeDarwinX64(ConanFile):
    ...
    name = "cmake-darwin-x64"
    description = (
        "Pre-built CMake bundle for darwin-x64. Source: official Kitware/CMake release binaries. Carries bin/cmake + bin/ctest + bin/cpack and the full share/cmake-<maj.min>/ module tree; docs/man dropped."
    )
