"""Conan recipe — `windows-x64` uv prebuilt bundle.
...
class UvWindowsX64(ConanFile):
    name = "uv-windows-x64"
    description = (
        "Pre-built uv bundle for windows-x64. Source: official astral-sh/uv release binaries. Carries bin/uv + bin/uvx."
    )
