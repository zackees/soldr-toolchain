"""Conan recipe — `linux-arm64-gnu` uv prebuilt bundle.
...
class UvLinuxArm64Gnu(ConanFile):
    ...
    name = "uv-linux-arm64-gnu"
    description = (
        "Pre-built uv bundle for linux-arm64-gnu. Source: official astral-sh/uv release binaries. Carries bin/uv + bin/uvx."
    )
