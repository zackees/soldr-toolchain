"""Conan recipe — `darwin-arm64` Ninja prebuilt bundle.
...
Both darwin shapes repackage the same universal `ninja-mac.zip`
binary.
"""
...
class NinjaDarwinArm64(ConanFile):
    name = "ninja-darwin-arm64"
    description = (
        "Pre-built Ninja bundle for darwin-arm64. Source: official ninja-build/ninja release binaries. Carries just bin/ninja."
    )
    license = "Apache-2.0"
