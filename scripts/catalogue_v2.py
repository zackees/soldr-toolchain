...
from scripts.publication_model import MAX_ASSET_BYTES, MAX_PART_BYTES, MAX_PART_COUNT, _digest

CATALOGUE_V2 = 2
_TOP_KEYS = frozenset(("schema_version", "generated_at", "origin", "entries"))
_ENTRY_KEYS = frozenset(("owner", "repo", "tag", "asset", "sha256", "size_bytes", "urls", "parts"))
...
def build_document(entries: list[dict[str, Any]], **metadata: Any) -> dict[str, Any]:
    document = {"schema_version": CATALOGUE_V2, **metadata, "entries": entries}
