...
RESERVED_TOP_LEVEL = {
    ...
    "asset-index.json",
    "catalogue.v1.json",
    # Generated by scripts.build_rust_nightly_versions and consumed by Soldr's
    # nightly/Dylint toolchain resolver; it is a catalogue, not a tool dir.
    "rust-nightly-versions.v1.json",
